...
listArrEl.forEach(function (element, index) {
  console.log("Category: ", listArrEl[index].firstElementChild.textContent);
  console.log("Elements: ", listArrEl[index].lastElementChild.children.length);
});
